...
public class Consent {
    ...
    public static void update(final Map<String,Object> consents) {
        ...
        final Event event = new Event.Builder(ConsentConstants.EventNames.CONSENT_UPDATE_REQUEST, ConsentConstants.EventType.CONSENT, ConsentConstants.EventSource.UPDATE_CONSENT).setEventData(consents).build();
